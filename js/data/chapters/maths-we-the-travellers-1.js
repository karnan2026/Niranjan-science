...
SUBJECTS.find(s => s.id === 'maths').chapters.push({
  ...
  --------------------------------------------------------------- */
  scenarios: [
    { imageUrl: "assets/img/maths-we-the-travellers-1/scn-01-school-trip.svg", imageAlt: "Bar chart showing how many people a car, autorickshaw, tempo traveller and minibus can carry", scenarioText: "Meera's class of 24 students and 1 teacher is going on a school trip. They need one vehicle that everyone can fit into.", question: "Which vehicle from the chapter's table should they book?", options: ["Car", "Tempo traveller", "Minibus", "Autorickshaw"], correctIndex: 2, explanation: "25 people (24 students + 1 teacher) need to travel together, and the minibus is the only vehicle listed that carries that many." },
